...
# ---------------------------
# log directory one level up from this script so logs will be outputted to src/logs
...
# Define class weights to balance predictions
class_weights = torch.tensor([1.0, 1.0]).to(device)  # [Not Buggy, Buggy]
...
logging.info("Model loaded with weighted loss function for balanced classification.")
...
# ---------------------------
# PHASE 1: TRAIN ON SSTUBS4J UNIQUE DATASET USING BEST HYPERPARAMETERS
# ---------------------------
best_lr = 2e-05
best_bs = 8
num_epochs = 3
