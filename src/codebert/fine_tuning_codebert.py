...
# ---------------------------
# Make log directory one level up from this script so logs will be outputted to src/logs
...
# Track best model (using F1 as primary metric as it gives a balance between percision and recall)
best_f1 = -float("inf")
best_config = None
